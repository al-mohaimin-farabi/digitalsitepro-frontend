  ...
  return (
    <>
      <div className="md:max-w-[960px] lg:max-w-[1280px] mx-auto mt-[130px] py-2 px-3 md:p-2 font-inter my-8">
        <h2 className="text-white text-2xl md:text-3xl uppercase font-inter tracking-wide mb-2">
        ...
        <div className="grid  grid-cols-1 md:grid-cols-3 mt-5 gap-5">
          <div className="py-4 px-6 text-left text-balance bg-gray-100 rounded">
            <FontAwesomeIcon
              className="text-grey-900/80 font-extrabold text-4xl"
              icon={faCode}
            />

            <h4 className="text-grey-900/80 text-lg font-bold my-4">
              Web Deblopment
            </h4>
          ...
          <div className="py-4 px-6 text-left text-balance bg-gray-100  rounded-md ">
            <FontAwesomeIcon
              className="text-grey-900/80 font-extrabold text-4xl"
              icon={faPalette}
            />
          ...
          <div className="py-4 px-6 text-left text-balance bg-gray-100 rounded">
            ...
            <h4 className="text-grey-900/80 text-lg font-bold my-4">SEO</h4>
            <p className="w-full sm:w-4/5 mx-auto md:w-full text-balance text-gray-600">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Earum
              suscipit eveniet itaque sed quasi ullam accusamus iusto,
              praesentium amet vitae.
          ...
          <div className="py-4 px-6 text-left text-balance bg-gray-100 rounded-md ">
            <FontAwesomeIcon
              className="text-grey-900/80 font-extrabold text-4xl -rotate-45"
              icon={faBullhorn}
            />
