...
const ServicesCard = ({ item }) => {
  ...
  return (
    <motion.div
      ...
      <div
        className={`relative md:w-[350px] grid p-3 md:p-1 grid-place-content-center grid-cols-1 text-center md:px-[40px] bg-[#222121] rounded-3xl text-white font-inter border-[4px] border-[#6B3D96] py-[30px]`}>
        <img
        ...
        <p className="my-4 text-sm text-wrap">{item?.peragraph}</p>
        <NavLink
