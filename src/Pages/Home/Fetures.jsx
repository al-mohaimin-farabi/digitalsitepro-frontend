...
const Fetures = () => {
  ...
  return (
    <div className="md:max-w-[960px] -mt-[120px] md:h-[365px] lg:h-[360px] md:-mt-[175px]  lg:-mt-[180px] relative z-[99999] lg:max-w-[1280px] mx-auto px-2 md:px-0 ">
      <motion.div
        initial="intial"
        animate={doAnimation ? "animate" : "initial"}
        variants={animateFeture}
        className="w-[100%]  mx-auto   py-5 md:py-0 relative   px-2">
