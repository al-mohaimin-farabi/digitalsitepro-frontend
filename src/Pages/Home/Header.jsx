  ...
  return (
    <header
      ...
      <div className="min-w-[100%] md:min-w-0 md:md:max-w-[960px] lg:max-w-[1280px]  py-12 grid place-items-center  text-center font-cardo text-balance z-[50]">
        <h1 className=" relative text-white md:-mt-[30px] lg:-mt-[50px]  mb-[20px] text-[32px] sm:text-[40px] md:text-[45px] font-extrabold my-2 px-1  uppercase tracking-widest text-pretty break-words ">
          Digital Site Pro <br />
          Studio <span className={`${HomeCss.gradient_text}`}>Live</span>
        </h1>
        <p className="px-1 my-4 capitalize max-w-[380px] sm:max-w-[750px]  text-sm sm:text-base md:text-xl text-white font-normal text-balacne">
