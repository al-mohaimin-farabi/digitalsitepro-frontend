...
const Auth = () => {
  ...
  return (
    <div className="mt-[104px] min-h-[calc(100svh-104px)] md:h-[calc(100svh-104px)] md:max-w-[960px] lg:max-w-[1280px] mx-auto px-4 py-5 grid content-center md:place-content-center">
      <div className=" grid grid-cols-1 place-content-center w-full  min-h-[518px] max-h-[627px] md:max-h-[100%] md:max-w-[940px] md:min-h-[627px]  rounded-lg overflow-hidden bg-gray-100">
        <div className=" min-h-[518px] md:min-h-[627px]  z-20  grid grid-cols-1 w-full md:grid-cols-2 md:gap-5 content-center  shadow-lg  ">
          ...
          <motion.div
            ...
            }    py-4 px-6 z-10 hidden full-bg h-full md:min-h-[627px] md:grid place-content-center text-center `}>
            <h2 className="text-4xl md:text-5xl text-white font-bold font-hero  my-2 z-50">
              Hello, Friends
            </h2>
            ...
            <button
              className="transition-all hideState mt-4 px-12 py-4 rounded-lg bg-transparent border-2 border-white hover:bg-white hover:text-primary w-max mx-auto text-white font-bold"
