          ...
          <li className="text-base flex items-center relative group cursor-pointer">
            {user?.email && user.emailVerified ? (
              ...
              <NavLink
                ...
                }  border-2 border-purple-bright hover:text-[#ffffff] hover:bg-purple-bright  py-3 px-6  min-w-[180px] transition-colors duration-200 ease-linear  hideState rounded-full`}>
                Login
              </NavLink>
            )}
          </li>
